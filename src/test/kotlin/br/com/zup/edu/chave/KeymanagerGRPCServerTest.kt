...
internal class KeymanagerGRPCServerTest {
    ...
    val DEFAULT_NUMERO = "NUMEROCONTA"
    val DEFAULT_TIPO_CONTA = TipoConta.CONTA_CORRENTE
    val DEFAULT_TIPO_CHAVE = TipoChave.CPF
    val DEFAULT_CHAVE = "12345678901"
    lateinit var requestBuilder: CreateKeyRequest.Builder

    @BeforeEach
    fun setup() {
        requestBuilder = CreateKeyRequest.newBuilder()
